...
## Project Structure
    ...
    ├── araliya_messanger_32341  # Django project configurations
...
1. Clone this repo and `cd araliya_messanger_32341`
...
2. Clone this repo and `cd araliya_messanger_32341`
